...
const handleAddOrUpdateContact = async (values) => {
  try {
    ...
    const enrollmentIdWithPrefix = `AZ${values.enrollmentId}`;
...
>
 ...
 >
  ...
  rules={[{ required: true, message: "Please input the Enrollment ID!" }]}
>
  <Input addonBefore="AZ" placeholder="Enter the ID number" />
</Form.Item>
  ...
  label="Service"
  name="service"
  initialValue="AMAZON" // Set default value to "WEBSITE"
  rules={[{ required: true, message: "Please select the service!" }]}
>
