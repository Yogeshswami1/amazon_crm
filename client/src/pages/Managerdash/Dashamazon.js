...
const Dashamazon = () => {
  ...
  // Updated logic to count based on 'Done' status
  const accountOpenInCount = filteredData.filter(item => item.accountOpenIn === 'Done').length;
  const accountOpenComCount = filteredData.filter(item => item.accountOpenCom === 'Done').length;
